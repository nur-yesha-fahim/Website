...
<head>
    ...
    <style>
        ...
        body { 
            ...
            background-image: 
                radial-gradient(at 0% 0%, hsla(253,16%,15%,1) 0, transparent 40%), 
                radial-gradient(at 50% 0%, hsla(225,39%,20%,1) 0, transparent 50%), 
                radial-gradient(at 100% 0%, hsla(339,49%,15%,1) 0, transparent 40%); 
        ...
        .glass-main-card {
            ...
            overflow: hidden; /* কন্টেন্ট যাতে কার্ডের বাইরে না যায় */
        }
        ...
        @media (max-width: 768px) {
            ...
            .glass-main-card { 
                margin: 0.75rem; /* মোবাইলে মার্জিন কিছুটা কমানো হয়েছে জায়গা বাঁচাতে */
        ...
        .profile-chip { 
            ...
            max-width: 180px; /* মোবাইলে যাতে বেশি জায়গা না নেয় */
        }
...
<body class="flex flex-col md:flex-row">
    ...
    <div class="md:hidden flex items-center justify-between p-5 bg-white/5 backdrop-blur-xl border-b border-white/10 z-[110]">
        <h1 class="text-xl font-black italic tracking-tighter">SERVICE<span class="text-blue-500">.</span></h1>
    ...
    <aside class="hidden md:flex flex-col w-72 glass-sidebar-card p-8 shrink-0">
        <div class="mb-12 px-2">
            <h1 class="text-2xl font-black tracking-tighter italic">SERVICE<span class="text-blue-500 text-3xl">.</span></h1>
        ...
        <div class="mt-auto p-4 opacity-20 text-[9px] font-black tracking-widest text-center uppercase">Service Hub v2.0</div>
    </aside>
        ...
        <main class="p-4 md:p-10 flex-1 overflow-y-auto">
            <div class="max-w-6xl mx-auto">
                <?php 
                    ...
                    else { echo "<div class='p-12 text-center text-slate-500 font-bold'>Tab Not Found</div>"; }
                ?>
            </div>
        </main>
    </div>
